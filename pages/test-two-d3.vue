...
const filteredResources = computed(() => {
  if (!selectedResource.value) return availableResources.value;
  return availableResources.value.filter(
    (resource: { id: string | number }) => resource.id === selectedResource.value
  );
});
