...
const emit = defineEmits(['updateFilter', 'updateResource', 'categoryChange', 'loadResource']);
...
<template>
  <USlideover v-model="isMobileSidebarOpen" side="left" :ui="{ width: 'w-screen max-w-[300px]', background: backgroundClass }">
    <div
